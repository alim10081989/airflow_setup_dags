...
with DAG('sequence_dag', description='DAG workflow with tasks executed sequentially',
          schedule_interval='0 */2 * * *',
          start_date=datetime(2022, 8, 18),
          catchup=False,
          tags=['first', "check"]) as dag:
    ...
    ## Python operator to call tasks defined as functions.
